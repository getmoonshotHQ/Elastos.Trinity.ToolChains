...
class ElastOSGenerator extends Generator {
  ...
  async prompting() {
    if (this.options.react) {
      ...
      this.log(
        yosay("Welcome to the " + chalk.red("elastOS") + " app generator!")
      );
  ...
  main() {
    if (this.outputAppType === "react") {
      ...
      throw new Error(
        `Unexpected app output type selected: ${this.outputAppType}`
      );
    }
  }
}

module.exports = ElastOSGenerator;
